    ...
    public partial class ManualViewer
    {
        public static void ShowInfo(Button button)
        {
            if (button.Name == "telegram_bot_token_i")
                ...
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_chats_id \n\nList of Telegram Group Chat or Direct Chat with Bot ids from where Bot can accept commands. This parameter is checked before telegram_allowed_users_id.\nIf this parameter is empty, Bot will execute commands from any Group Chat or direct Chat with Bot\nIf you want to give access for specific users in a specific Group Chat or direct Chat with Bot, you have to add Group or direct Chat with Bot ids here and those Users` ids in telegram_allowed_users_id parameter\nIf you want to give access to any user in a Group Chat or direct Chat with Bot, then you have to add Group`s or direct Chat with Bot ids here and leave empty telegram_allowed_users_id parameter\nIf you want to give access only for you or specific list of Users but prevent access from any Chat Group or direct Chat with Bot, you have to add Users` ids here and into telegram_allowed_users_id parameter");
            else if (button.Name == "telegram_allowed_users_id_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_users_id \n\nList of Telegram Users` ids from whom Bot can accept commands. This parameter is checked after telegram_allowed_chats_id.\nIf this parameter is empty, Bot will execute commands from any User.\nIf this paramatere has values, then only specified Users will have access to send commands to Bot");
            else if (button.Name == "telegram_allowed_users_id_emergency_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_users_id_emergency \n\nList of Telegram Users` ids from whom Bot can accept /emergency command. This parameter is checked before telegram_allowed_chats_id_emergency. If User is in the list, then User will have a permission to execute this command");
            else if (button.Name == "telegram_allowed_chats_id_emergency_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_chats_id_emergency \n\nList of Telegram Group Chats or private Chat with Bot ids from where Bot can accept /emergency command. This parameter is checked after telegram_allowed_users_id_emergency. If Group Chat or private Chat with Bot id is in the list, then Bot will execute this command");
            else if (button.Name == "telegram_allowed_users_id_reloadconfig_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_users_id_reloadconfig \n\nList of Telegram Users` ids from whom Bot can accept /reloadconfig command. This parameter is checked before telegram_allowed_chats_id_emergency. If User is in the list, then User will have a permission to execute this command");
            else if (button.Name == "telegram_allowed_chats_id_reloadconfig_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_chats_id_reloadconfig \n\nList of Telegram Group Chats or private Chat with Bot ids from where Bot can accept /reloadconfig command. This parameter is checked after telegram_allowed_users_id_reloadconfig. If Group Chat or private Chat with Bot id is in the list, then Bot will execute this command");
            else if (button.Name == "telegram_allowed_users_id_getcommands_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_users_id_getcommands \n\nList of Telegram Users` ids from whom Bot can accept /getcommands command. This parameter is checked before telegram_allowed_chats_id_getcommands. If User is in the list, then User will have a permission to execute this command");
            else if (button.Name == "telegram_allowed_chats_id_getcommands_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_chats_id_getcommands \n\nList of Telegram Group Chats or private Chat with Bot ids from where Bot can accept /getcommands command. This parameter is checked after telegram_allowed_users_id_getcommands. If Group Chat or private Chat with Bot id is in the list, then Bot will execute this command");
            else if (button.Name == "telegram_allowed_users_id_remindme_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_users_id_remindme \n\nList of Telegram Users` ids from whom Bot can accept /getcommands command. This parameter is checked before telegram_allowed_chats_id_remindme. If User is in the list, then User will have a permission to execute this command");
            else if (button.Name == "telegram_allowed_chats_id_remindme_i")
                MessageBox.Show("Parameter in config.json file is: telegram_allowed_chats_id_remindme \n\nList of Telegram Group Chats or private Chat with Bot ids from where Bot can accept /remindme command. This parameter is checked after telegram_allowed_users_id_remindme. If Group Chat or private Chat with Bot id is in the list, then Bot will execute this command");
